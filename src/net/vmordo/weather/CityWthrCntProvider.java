...
public class CityWthrCntProvider extends ContentProvider {
	final String LOG_TAG = "CityWthrCntProvider";
	...
	// Таблица
	static final String CONTACT_TABLE = "city";

	// Поля
	static final String CONTACT_ID = "_id";
	static final String CONTACT_NAME = "city_name";
	static final String CONTACT_EMAIL = "ctemp";

	// // Uri
	// authority
	static final String AUTHORITY = "net.vmordo.weather.providers";

	// path
	static final String CONTACT_PATH = "city";
	...
	Db_Helper dbHelper; // my one for db
	SQLiteDatabase db;
